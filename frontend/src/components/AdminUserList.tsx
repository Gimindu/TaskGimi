...
import { ShieldCheck, User as UserIcon, CheckSquare, CheckCircle2, Clock, UserCheck, UserX } from 'lucide-react';
...
export const AdminUserList: React.FC<AdminUserListProps> = ({
  ...
  return (
    <div className="bg-[#141417] rounded-3xl border border-[#242429] p-6 shadow-md mb-6">
      {/* Header */}
